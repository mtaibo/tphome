...
<template>
    ...
    <div class="flex flex-col md:flex-row h-full w-full overflow-hidden min-h-0">
        ...
        <div class="fixed inset-0 md:top-20 pointer-events-none z-0"></div>

        <!-- Blueprint itself -->
        <div class="flex-1 flex items-center justify-center p-4 md:p-12 md:pb-12 transition-all duration-500 ease-in-out min-h-0 overflow-hidden">
